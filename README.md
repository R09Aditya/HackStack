...
- Individual pages for each tool:
  ...
  - Burp Suite (Web Interception & Exploitation)
...
├── tools.html # Tool selection dashboard
├── nmap.html # Nmap module page
├── burp.html # Burp Suite module page
